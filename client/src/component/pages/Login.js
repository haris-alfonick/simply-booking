            ...
            <div className='w-full max-w-md mt-[-100px]'>
                ...
                <div className='bg-white rounded-2xl shadow-lg p-8 '>
                    ...
                    <div className='space-y-5'>
                        <div>
                            ...
                            <input type='email'
                                ...
                                className='w-full px-4 py-2 bg-gray-50 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-400' placeholder='Enter your email' />
                        </div>
                        <div>
                    ...
                    <div className='mt-6 text-center'>
                        <p className='text-sm text-gray-600'>Don't have an account? <Link to='/signup' className='text-blue-500 hover:text-blue-600 font-bold'>Sign Up</Link></p>
                    </div>
