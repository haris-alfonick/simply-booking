...
import { Calendar, Globe, BarChart3, DollarSign, FileText, Plus, Share2, CheckCircle, Phone, Mail, Clock } from 'lucide-react';
...
export default function Homepage() {
  ...
  const jobs = [
    { client: 'Sarah Johnson', service: 'Junk Removal', location: 'Los Angeles, CA', status: 'Confirmed' },
    { client: 'Mark Davis', service: 'Appliance Assembly', location: 'Anaheim, FL', status: 'Confirmed' },
    { client: 'Kevin Patel', service: 'Furniture Delivery', location: 'San Francisco, CA', status: 'Confirmed' }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* <header className="bg-gradient-to-br from-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="text-2xl font-bold text-cyan-500">SimplyBooking</div>
            <nav className="hidden md:flex space-x-8">
              <a href="#" className="text-gray-600 hover:text-gray-900">About Us</a>
              <a href="#" className="text-gray-600 hover:text-gray-900">Contact Us</a>
              <a href="#" className="text-gray-600 hover:text-gray-900">Join</a>
        ...
        <div className="max-w-9xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <Link href="#" className="text-gray-600 hover:text-gray-900">Join</Link>

              <button className="bg-cyan-500 text-white px-4 py-2 rounded hover:bg-cyan-600 mt-[-5px]">
                Log In →
              </button>
            </nav>
          </div>
          ...
          <div className='mt-20'>
            ...
            <div className='bg-white p-6 mt-7 rounded-lg mb-5 border-0'>
              ...
              <div className="mt-8 bg-white  shadow-sm overflow-hidden">
                {jobs.map((job, i) => (
                  <div key={i} className="flex items-center justify-between p-4 hover:bg-gray-50 border-2 border-gray-100 mt-3 rounded-lg">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {features.map((feature, i) => (
              <div key={i} className="bg-white rounded-lg p-8 shadow-sm hover:shadow-md transition border-2 border-gray-100">
                {/* <div className="bg-gradient-to-r from-orange-400 to-blue-500 w-14 h-14 rounded-lg flex items-center justify-center mb-4">
                  {feature.icon}
                </div> */}
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {process.map((step, i) => (
              <div key={i} className="text-center border-2 border-gray-100 p-8 rounded-lg">
                <div className='flex items-center gap-1 mb-2 mx-auto'>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-8 relative">
              <div className="absolute -top-12 left-8 bg-white p-2 rounded-lg shadow-md">
              ...
              <div className="mt-14">
                ...
                <div className="grid grid-cols-3 gap-4 mb-8">
                  <div className="text-center p-4 bg-gray-50 rounded-lg flex gap-2 items-center">
                    <div className="text-cyan-500 mb-2 h-8 w-8 flex items-center justify-center rounded-lg bg-gray-200"><Phone /></div>
                    <div className="mx-2">
                  ...
                  <div className="text-center p-4 bg-gray-50 rounded-lg flex gap-2 items-center">
                    <div className="text-cyan-500 h-8 w-8 flex items-center justify-center rounded-lg bg-gray-200"><Mail /></div>
                    <div className="mx-2">
                  ...
                  <div className="text-center p-4 bg-gray-50 rounded-lg flex gap-2 items-center">
                    <div className="text-cyan-500 mb-2  h-8 w-8 flex items-center justify-center rounded-lg bg-gray-200"><Clock /></div>
                    <div className="mx-2">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <div className="mt-4 inline-flex items-center px-4 py-2 bg-cyan-50 text-cyan-700 rounded-full text-sm">
              💎 Auto-upgrade available if request limit is reached
            </div>
          </div>
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {pricingPlans.map((plan, i) => (
              <div key={i} className={`rounded-lg p-8 ${plan.popular ? 'bg-cyan-50 border-2 border-cyan-500 shadow-lg transform scale-105' : 'bg-white border-2 border-gray-200'}`}>
                {plan.popular && (
      ...
      <section className="py-20 bg-gradient-to-br from-cyan-400 to-cyan-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <div className="mb-4 text-sm">✓Free Setup • No Credit Card Required</div>
